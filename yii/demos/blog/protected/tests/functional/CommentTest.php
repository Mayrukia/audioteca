...
class CommentTest extends WebTestCase
{
	...
	public function testCreate()
	{
	    ...
	    $this->assertTextPresent('Name no puede estar en blanco.');
	    $this->assertTextPresent('Email no puede estar en blanco.');
	    $this->assertTextPresent('Comment no puede estar en blanco.');
