...
abstract class CBaseListView extends CWidget
{
	...
	{
		$mensajeError= '<p tabindex="6"><b>Este título no está disponible. Te agradeceríamos lo propongas en nuestra sección de <a tabindex="7" href="../contacto.html">Contacto</a></b></p>';
		$emptyText=$this->emptyText===null ? Yii::t('zii', $mensajeError) : $this->emptyText;
	...
	public function renderSummary()
	{
		...
		if (!strpos($url,'bibliotecaIdiomas') && !strpos($url,'libros/view'))
		{
